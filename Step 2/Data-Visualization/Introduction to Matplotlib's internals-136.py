...
ax1.set(xlim=[0,13], ylim=[10,110], xlabel='Month 2013', ylabel='Temperature 2013' ,title='2013')
ax1.scatter(month_2013, temperature_2013, color='darkblue', marker='o')

ax2.set(xlim=[0,13], ylim=[10,110], xlabel='Month 2014', ylabel='Temperature 2014' ,title='2014')
