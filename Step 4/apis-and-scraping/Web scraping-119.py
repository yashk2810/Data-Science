...
second_inner = parser.find_all('p', class_='inner-text')[1]
second_inner_paragraph_text = second_inner.text

first_outer = parser.find_all('p', class_='outer-text')[0]
first_outer_paragraph_text = first_outer.text
...
outer = parser.select(".outer-text")
first_outer_text = outer[0].text
...
patriots_total_plays_count = plays.select('td')[2].text
print(patriots_total_plays_count)

yards = parser.select('#total-yards')[0]
seahawks_total_yards_count = yards.select('td')[1].text
