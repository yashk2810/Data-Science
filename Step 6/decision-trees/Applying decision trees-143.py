...
error_train = roc_auc_score(predictions, train['high_income'])
print(error_train)
...
pre1 = clf.predict(train[columns])
train_auc = roc_auc_score(pre1, train['high_income'])
print(train_auc)

pre2 = clf.predict(test[columns])
test_auc = roc_auc_score(pre2, test['high_income'])
print(test_auc)
