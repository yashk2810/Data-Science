...
for theta in theta1s:
    c.append(cost(theta0, theta, pga['distance'], pga['accuracy']))
...
costs = gradient_descent(pga.distance, pga.accuracy, alpha=0.01)['costs']
length = range(0,len(costs))
print(costs)

plt.plot(length, costs)
plt.show()